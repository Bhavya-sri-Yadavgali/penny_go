...
class _$CategoryModelImpl implements _CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, userId: $userId, name: $name, icon: $icon, color: $color, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, name, icon, color, createdAt);
